...
$deleteshapevar = $_GET['deleteshapevar'];
$query = "DELETE FROM characteristic WHERE Category_FK = :removedSpecies";

$statement = $pdo->prepare($query);
$statement->bindValue(':removedSpecies', $deleteshapevar);
$statement->execute();

$query = "DELETE FROM shape WHERE Shape_Category_ID = :removedSpecies";
