...
$smarty->assign("id", $id);
$smarty->assign('consId', $id); //this id wont change in the tpl

//------- Queries for characteristics names and characteristics options------
$query = "SELECT Characteristic_ID, c.Name as Char_Name, Option_ID, Option_Name as Opt_Name
...
if (isset($_POST["selectSpecies"])) {
	...
	$query = "SELECT DISTINCT Species_ID, k.Scientific_Name_Without
